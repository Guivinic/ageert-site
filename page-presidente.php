...
<div id="agert-react-app">
    ...
    <div id="agert-loading" class="agert-loading">
        <div style="text-align: center;">
            ...
            <p>Carregando informações do presidente...</p>
        </div>
    </div>
                    ...
                    <article class="bg-white rounded-lg shadow-sm p-8">
                        ...
                        <?php if (has_post_thumbnail()) : ?>
                            <div class="mt-8 text-center">
                                <?php the_post_thumbnail('medium', array('class' => 'rounded-lg mx-auto')); ?>
                            </div>
                        <?php endif; ?>
                    </article>
                <?php endwhile; endif; ?>
...
document.addEventListener('DOMContentLoaded', function() {
    if (window.AgertReactApp) {
        // Set initial page to presidente
        window.location.hash = '#presidente';
    }
});
</script>
